...
export default function Operations({ form }: { form: InertiaFormProps }) {
  return (
    <div className="w-full bg-card p-6 md:p-8 rounded-xl grid gap-6">
      <Checkbox
        name="working_days"
      ...
      <div className="grid lg:grid-cols-4 gap-5">
        ...
        <Input name="close_at" label="Closes at" type="time" form={form} />

      </div>

      <div className="w-1/2">
        <RadioGroup
          name="holidays_includes"
