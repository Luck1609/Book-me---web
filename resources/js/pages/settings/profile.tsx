          ...
          <div className="space-y-8 p-5 sm:p-8">
            <section className="space-y-5">
              ...
              <div className="grid gap-6 lg:grid-cols-[180px_minmax(0,1fr)] lg:items-center">
                <div className="flex flex-col items-center gap-3 rounded-2xl bg-[#f6faf8] px-5 py-6 dark:bg-[#101917]">
                  <Avatar className="size-28 rounded-3xl shadow-[0_10px_25px_rgba(23,52,60,0.1)] ring-4 ring-white dark:ring-[#17221f]">
                    <AvatarImage src={auth.user.avatar} alt={auth.user.name} />
                    <AvatarFallback className="rounded-3xl bg-[#d9f7e8] text-2xl font-bold text-[#0f6b4d] dark:bg-[#0f8a62]/20 dark:text-[#8fe0bb]">
                ...
                <FileUploader
                  ...
                  classNames={{
                    wrapper:
                      'min-h-40 border-[#b9dfcc] bg-[#fbfefc] hover:bg-[#f0faf4] dark:border-[#286c51] dark:bg-[#101917] dark:hover:bg-[#0f8a62]/10',
                    header: {
                      title: 'text-base text-[#17343c] dark:text-white',
