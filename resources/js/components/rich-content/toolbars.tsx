...
const toolbarStyle =
  'rounded-[6px] p-1 text-gray-500 transition delay-150 hover:bg-black hover:text-white';
...
export const RTUndo = ({
  ...
  return (
    <Button
      ...
      className={cn(
        toolbarStyle,
        editor.isActive('undo') && activeStyle,
        'h-8 w-8',
        className,
      )}
...
export const RTRedo = ({
  ...
  return (
    <Button
      ...
      className={cn(
        toolbarStyle,
        editor.isActive('redo') && activeStyle,
        'h-8 w-8',
        className,
      )}
