...
export default function TableFilter<TData>({
  ...
  return (
    <div className={cn('flex items-center space-x-3 lg:w-[400px]', className)}>
      <div className="relative flex w-full items-center gap-2 bg-white">
        <Search className="absolute top-3 left-2.5 size-4" />
        <Input
          placeholder="Search by agency name"
          onChange={handleSearch}
          className="w-full border pl-8 shadow-none lg:flex-1"
          type="search"
        />
      </div>
